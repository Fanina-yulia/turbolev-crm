...
export function TelephonyRealtimeBridge() {
  ...
  useEffect(() => {
    ...
    const onDocumentClick = (event: MouseEvent) => {
      ...
      if (!element) return;
      if (extractPhoneCandidates(element.textContent || "").length > 0) return;
