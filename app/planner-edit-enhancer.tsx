...
export function PlannerEditEnhancer() {
  ...
  return <div className="plannerEditEnhancerBackdrop" data-planner-edit-enhancer="true" onMouseDown={(event) => { if (event.target === event.currentTarget && !saving) closeLegacy(); }}>
    <section className="plannerEditEnhancerModal" onMouseDown={(event) => event.stopPropagation()}>
      ...
      <div className="plannerEditEnhancerScroll">
        <section className="plannerEditVehicleCard">
          <VehiclePlate value={displayPlate} size="md" className="plannerEditPlate" title={`Держномер ${displayPlate}`} />
    ...
    <style jsx global>{`
      ...
      .plannerEditEnhancerHead p{margin:0 0 3px;color:var(--orange);font-size:11px;font-weight:900;letter-spacing:.12em}.plannerEditEnhancerHead span{color:var(--muted);font-size:11px}.plannerEditEnhancerHead>button{width:35px;height:35px;border:1px solid var(--line);border-radius:10px;background:var(--panel-2);color:var(--text);font-size:20px;cursor:pointer}
      ...
      .plannerEditPlate{width:189px!important;height:38px!important}.plannerEditVehicleMain{min-width:0}.plannerEditVehicleMain h2{margin:0;font-size:20px;line-height:1.15;letter-spacing:-.025em}.plannerEditVehicleMain p{margin:5px 0;color:var(--muted);font-size:11px}.plannerEditVehicleMain>div{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.plannerEditVehicleMain>div span{color:var(--muted);font-size:11px}.plannerEditVehicleMain>div button{border:0;background:transparent;color:var(--orange);padding:0;font-size:11px;font-weight:800;cursor:pointer}.plannerEditVehicleState{display:flex;flex-direction:column;align-items:flex-end;gap:7px}.plannerEditVehicleState span{padding:5px 8px;border:1px solid var(--line);border-radius:999px;color:var(--muted);font-size:11px}.plannerEditVehicleState strong{padding:7px 10px;border-radius:999px;background:color-mix(in srgb,var(--orange) 12%,var(--panel));color:var(--orange);font-size:11px;white-space:nowrap}
      .plannerEditNotice,.plannerEditSuccess{padding:10px 12px;border:1px solid var(--line);border-radius:10px;color:var(--muted);font-size:11px}.plannerEditSuccess{border-color:color-mix(in srgb,#16a34a 40%,var(--line));background:color-mix(in srgb,#16a34a 7%,var(--panel));color:#16a34a}.plannerEditError{display:flex;gap:10px;align-items:center;padding:10px 12px;border:1px solid color-mix(in srgb,#dc2626 42%,var(--line));border-radius:10px;background:color-mix(in srgb,#dc2626 6%,var(--panel));font-size:11px}.plannerEditError strong{color:#dc2626}.plannerEditError span{color:var(--muted)}
      .plannerEditSection{padding:14px;border:1px solid var(--line);border-radius:14px;background:var(--panel)}.plannerEditSectionTitle{display:flex;justify-content:space-between;align-items:flex-end;gap:14px;margin-bottom:11px}.plannerEditSectionTitle small{display:block;margin-bottom:3px;color:var(--orange);font-size:11px;font-weight:900;letter-spacing:.11em}.plannerEditSectionTitle h3{margin:0;font-size:14px}.plannerEditSectionTitle>span{color:var(--muted);font-size:11px;text-align:right}
      .plannerEditGrid{display:grid;gap:9px}.plannerEditGrid3{grid-template-columns:repeat(3,minmax(0,1fr))}.plannerEditGrid label,.plannerEditTextSection label{display:grid;gap:5px}.plannerEditGrid label>span,.plannerEditTextSection label>span{color:var(--muted);font-size:11px;font-weight:750;text-transform:uppercase}.plannerEditGrid input,.plannerEditGrid select,.plannerEditTextSection textarea{width:100%;border:1px solid var(--line);border-radius:9px;background:var(--panel-2);color:var(--text);font:inherit}.plannerEditGrid input,.plannerEditGrid select{height:40px;padding:0 10px;font-size:11px}.plannerEditTextSection{display:grid;gap:11px}.plannerEditTextSection textarea{resize:vertical;min-height:62px;padding:10px 11px;font-size:11px;line-height:1.45}.plannerEditTextSection label>small{color:var(--muted);font-size:11px}
      .plannerEditConflict{margin-top:10px;padding:11px 12px;border:1px solid color-mix(in srgb,#dc2626 45%,var(--line));border-radius:11px;background:color-mix(in srgb,#dc2626 5%,var(--panel));display:grid;gap:7px}.plannerEditConflict>div{display:flex;align-items:center;justify-content:space-between;gap:12px}.plannerEditConflict>div b{color:#dc2626;font-size:11px}.plannerEditConflict>div span,.plannerEditConflict small{color:var(--muted);font-size:11px}.plannerEditConflict p{margin:0;display:grid;grid-template-columns:180px 1fr;gap:9px;padding-top:6px;border-top:1px solid color-mix(in srgb,#dc2626 20%,var(--line));font-size:11px}.plannerEditConflict p strong{color:var(--text)}.plannerEditConflict p span{color:var(--muted)}
      .plannerEditChanges{padding:11px 13px;border:1px dashed color-mix(in srgb,var(--orange) 45%,var(--line));border-radius:11px;background:color-mix(in srgb,var(--orange) 4%,var(--panel));display:grid;gap:4px}.plannerEditChanges b{font-size:11px}.plannerEditChanges span{color:var(--muted);font-size:11px}
      .plannerEditEnhancerFoot{display:flex;justify-content:flex-end;gap:8px;padding:13px 20px;border-top:1px solid var(--line);background:var(--panel)}.plannerEditEnhancerFoot button{min-height:41px;border-radius:10px;padding:0 14px;font-size:11px;font-weight:850;cursor:pointer}.plannerEditEnhancerFoot button:disabled{opacity:.45;cursor:default}.plannerEditSecondary{border:1px solid var(--line);background:var(--panel-2);color:var(--text)}.plannerEditPrimary{border:1px solid var(--orange);background:var(--orange);color:#fff}.plannerEditDiagnostics{border:1px solid #16a34a;background:#16a34a;color:#fff}
      @media(max-width:760px){.plannerEditEnhancerBackdrop{padding:8px}.plannerEditEnhancerModal{width:100%;max-height:calc(100vh - 16px);border-radius:14px}.plannerEditEnhancerScroll{padding:12px}.plannerEditVehicleCard{grid-template-columns:179px 48px 1fr}.plannerEditVehicleState{grid-column:1/-1;flex-direction:row;align-items:center}.plannerEditPlate{width:179px!important;height:36px!important}.plannerEditGrid3{grid-template-columns:1fr}.plannerEditSectionTitle{align-items:flex-start;flex-direction:column}.plannerEditEnhancerFoot{padding:10px 12px;flex-wrap:wrap}.plannerEditEnhancerFoot button{flex:1;min-width:130px}.plannerEditConflict p{grid-template-columns:1fr}}
    `}</style>
  </div>;
}
