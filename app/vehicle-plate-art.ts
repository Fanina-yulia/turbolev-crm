...
export function plateSvgMarkup(display: string) {
  ...
  const textStyle = `font-family="Arial Narrow, Nimbus Sans Narrow, Arial, sans-serif" font-size="106" font-weight="700" fill="#050505" stroke="#050505" stroke-width="0.8" stroke-linejoin="round" paint-order="stroke" letter-spacing="2" style="font-family:'Arial Narrow','Nimbus Sans Narrow',Arial,sans-serif!important;font-size:106px!important;font-weight:700!important;fill:#050505!important;stroke:#050505!important;letter-spacing:2px!important"`;
  const numberText = groups ? `${groups.left} ${groups.digits} ${groups.right}` : display;
  const numberMarkup = `<text x="66" y="101" xml:space="preserve" textLength="514" lengthAdjust="spacing" ${textStyle}>${escapeXml(numberText)}</text>`;
