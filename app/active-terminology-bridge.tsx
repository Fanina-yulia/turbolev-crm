...
const exactReplacements = new Map<string, string>([
  ...
  ["Для передачі в Активні потрібне серверне з'єднання", "Для створення звернення потрібне серверне з'єднання"],
  ...
  ["Не вдалося додати в Активні", "Не вдалося створити звернення"],
