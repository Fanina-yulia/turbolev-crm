...
export function PartsCatalog() {
  ...
  return <div className={styles.page}>
    ...
    {selectionResult && <section className={styles.panel}>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 12 }}><button className={styles.primary} type="button" onClick={() => navigateCrm("Замовлення-наряди", { workOrderId: selectionResult.workOrderId, workOrderTab: "estimate" })}>Відкрити КП</button><button type="button" onClick={() => navigateCrm("Замовлення-наряди", { workOrderId: selectionResult.workOrderId, workOrderTab: "parts" })}>Відкрити запчастини ЗН</button></div>
    </section>}
