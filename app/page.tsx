...
import { SidebarRailV4 } from "./auth/sidebar-rail-v4";
...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  return <>
    ...
    <CrmAccessProvider snapshot={clientAccess}>
      <BinotelRecordingProvider><SidebarRailV4/><CrmShell initialSection={section} initialSettingsTab={settingsTab} /></BinotelRecordingProvider>
    </CrmAccessProvider>
  </>;
}
