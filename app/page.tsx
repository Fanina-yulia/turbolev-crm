...
import { SidebarFinalPolish } from "./auth/sidebar-final-polish";
...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  return <><SidebarRail/><SidebarFinalPolish/><CrmShell initialSection={section} initialSettingsTab={settingsTab} /></>;
}
