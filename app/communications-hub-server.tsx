...
export function CommunicationsHub() {
  ...
  return <div className={styles.page}>
    ...
    <style jsx global>{`
      ...
      .communicationsReplyMeta{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:0 0 8px;color:var(--muted);font-size:11px}.communicationsReplyMeta label{display:flex;align-items:center;gap:6px;flex-wrap:wrap}.communicationsReplyMeta label small{color:var(--muted);font-size:11px;font-weight:500}.communicationsReplyMeta select{border:1px solid var(--line);border-radius:8px;background:var(--surface);color:var(--text);padding:5px 8px;font:inherit}.communicationsReplyMeta span{padding:5px 8px;border-radius:999px;background:var(--surface);border:1px solid var(--line)}.communicationsReplyMeta span.expired{color:#ef4444;border-color:rgba(239,68,68,.35);background:rgba(239,68,68,.07)}
      .communicationsChannelContext{display:flex;align-items:center;gap:7px;flex-wrap:wrap;margin-top:5px}.communicationsChannelContext b{display:inline-flex;align-items:center;gap:5px;color:var(--text);font-size:11px;font-weight:700}.communicationsChannelContext b i{display:inline-grid;place-items:center;width:17px;height:17px;border-radius:50%;color:#fff;font-style:normal;font-size:11px}.communicationsChannelContext em{font-style:normal;color:var(--muted);font-size:11px;font-weight:500;padding-left:7px;border-left:1px solid var(--line)}
      .communicationsChannelSwitch{align-self:center;margin:7px auto;padding:4px 9px;border:1px solid var(--line);border-radius:999px;background:var(--surface);color:var(--muted);font-size:11px}.communicationsChannelSwitch b{color:var(--text)}
      .communicationsFileChips{display:flex;gap:6px;flex-wrap:wrap;margin:0 0 8px}.communicationsFileChips>span{display:inline-flex;align-items:center;gap:6px;border:1px solid var(--line);border-radius:999px;background:var(--surface);padding:5px 8px;color:var(--muted);font-size:11px}.communicationsFileChips button{width:18px!important;height:18px!important;padding:0!important;border:0!important;border-radius:50%!important;background:transparent!important;color:var(--muted)!important}
      .communicationsMessageImages{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;margin-bottom:7px}.communicationsMessageImages a{display:block;overflow:hidden;border-radius:10px;border:1px solid var(--line);background:var(--surface);min-width:0}.communicationsMessageImages img{display:block;width:100%;max-height:240px;object-fit:cover}.communicationsMessageImages span{display:block;padding:10px;color:var(--text);font-size:11px}
      ...
      .communicationsDeliveryState{font-style:normal;color:var(--muted);font-size:11px}.communicationsDeliveryFailed{font-style:normal;color:#ef4444;font-size:11px}.communicationsRetryButton{margin-left:6px;border:1px solid rgba(239,68,68,.35);border-radius:999px;background:rgba(239,68,68,.07);color:#ef4444;padding:3px 7px;font:inherit;font-size:11px;cursor:pointer}.communicationsRetryButton:disabled{opacity:.5;cursor:wait}
      .communicationsLinkClientButton{margin-left:auto;border:1px solid var(--orange);border-radius:9px;background:transparent;color:var(--orange);padding:7px 10px;font:inherit;font-size:11px;cursor:pointer}.communicationsLinkPanel{border-bottom:1px solid var(--line);background:var(--surface);padding:12px 14px;display:grid;gap:9px}.communicationsLinkPanel>div:first-child{display:grid;gap:3px}.communicationsLinkPanel strong{font-size:11px}.communicationsLinkPanel span{font-size:11px;color:var(--muted)}.communicationsClientSearch{display:grid!important;grid-template-columns:minmax(0,1fr) auto auto;gap:6px!important}.communicationsClientSearch input{min-width:0;border:1px solid var(--line);border-radius:9px;background:var(--panel);color:var(--text);padding:8px 10px;font:inherit;font-size:11px}.communicationsClientSearch button{border:1px solid var(--line);border-radius:9px;background:var(--panel);color:var(--text);padding:7px 10px;font:inherit;font-size:11px;cursor:pointer}.communicationsClientResults{display:grid!important;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:6px!important}.communicationsClientResults>button{display:grid;text-align:left;gap:2px;border:1px solid var(--line);border-radius:10px;background:var(--panel);color:var(--text);padding:9px 10px;cursor:pointer}.communicationsClientResults>button:hover{border-color:var(--orange)}.communicationsClientResults small{font-size:11px;color:var(--muted)}.communicationsClientResults i{font-size:11px;color:var(--orange);font-style:normal}
      .communicationsIntegrationActions{display:flex;gap:7px;flex-wrap:wrap;margin-top:10px}.communicationsIntegrationActions button{border:1px solid var(--line);border-radius:9px;background:var(--surface);color:var(--text);padding:7px 10px;font:inherit;font-size:11px;cursor:pointer}.communicationsIntegrationActions button:disabled{opacity:.45;cursor:not-allowed}.communicationsIntegrationMeta{display:block;margin-top:7px;color:var(--muted);font-size:11px}
