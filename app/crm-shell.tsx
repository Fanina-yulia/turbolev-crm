...
type SettingsTab = "schedule"|"personnel"|"clients"|"suppliers"|"warehouse"|"workPrices"|"posts"|"markup"|"cash"|"integrations"|"appearance"|"workflow"|"security";
...
export function CrmShell({ initialSection }: { initialSection?: string }) {
  ...
  return <main className="shell">
    ...
    {active==="Огляд станції"&&canCreateRequest&&<div className={shellStyles.globalNewRequest}><NewRequestLauncher/></div>}
