...
export type LegacyCrmSectionLabel = "Виробництво" | "Контроль якості" | "Гарантії" | "Ліди" | "Активні";
...
export function slugFromSection(value: string): VisibleCrmSectionSlug {
  ...
  if (value === "Ліди" || value === "Активні") return "leads";
...
export function isCrmSection(value: string): value is CrmSectionLabel {
  return value === "Виробництво" || value === "Контроль якості" || value === "Гарантії" || value === "Ліди" || value === "Активні" || CRM_NAV.some((item) => item.label === value);
}
