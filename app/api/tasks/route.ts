...
async function appendWalkInAttention(attention: AttentionCenterResult, plannerLocationIds: string[] | null) {
...
export async function GET(request: NextRequest) {
  try {
    ...
    const attention = can(context, PERMISSIONS.PLANNER_READ)
      ? await appendWalkInAttention(baseAttention, plannerLocationIds)
      : baseAttention;
