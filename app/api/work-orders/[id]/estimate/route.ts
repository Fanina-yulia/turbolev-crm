...
import { assertEstimateMarginApprovedBeforeSend, EstimateMarginGateError } from "@/src/services/financial-estimate-margin-gate.service";
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    await assertEstimateMarginApprovedBeforeSend(id, actorName);
