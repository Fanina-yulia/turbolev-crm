...
export function ClientCardDrawer({open,name,phone,channel,existingLeadId,onClose,onCreateLead}:Props){
  ...
  return <div className="clientDrawerBackdrop" onMouseDown={event=>{if(event.target===event.currentTarget)onClose()}}>
    ...
    <style jsx global>{`
      ...
      .clientDrawerHead{display:flex;justify-content:space-between;gap:16px;padding:20px 22px;border-bottom:1px solid var(--line);background:var(--panel)}.clientDrawerHead p{margin:0;color:var(--orange);font-size:12px;font-weight:900;letter-spacing:.14em}.clientDrawerHead h2{margin:5px 0 3px;font-size:23px}.clientDrawerHead span{font-size:12px;color:var(--muted)}.clientDrawerHead>button{width:38px;height:38px;border:1px solid var(--line);border-radius:50%;background:var(--surface);color:var(--text);font-size:22px;cursor:pointer}
      .clientDrawerBody{padding:14px;overflow:auto;display:grid;gap:10px}.clientBlock{border:1px solid var(--line);border-radius:15px;background:var(--panel);padding:14px}.clientBlockTitle{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:11px}.clientBlockTitle b{font-size:14px}.clientBlockTitle span{font-size:12px;color:var(--muted)}
      .contactCompact>label,.vehicleAddCompact label{display:grid;gap:5px;color:var(--muted);font-size:12px}.contactCompact input,.vehicleAddCompact input{width:100%;box-sizing:border-box;border:1px solid var(--line);border-radius:10px;background:var(--surface);color:var(--text);padding:10px 11px;font:inherit;font-size:12px;outline:none}.contactCompact input:focus,.vehicleAddCompact input:focus{border-color:var(--orange)}.twoPhones{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:9px}.twoPhones label{display:grid;gap:5px}.twoPhones label>span{font-size:12px;color:var(--muted)}.saveContact{width:100%;margin-top:9px;border:0;border-radius:10px;background:var(--orange);color:#111;padding:10px;font-weight:850;cursor:pointer}.saveContact:disabled{opacity:.45}.clientMessage{margin-top:9px;border-radius:9px;background:color-mix(in srgb,var(--orange) 10%,transparent);padding:8px 9px;font-size:12px}.clientEmpty{padding:15px;text-align:center;color:var(--muted);font-size:12px}
      .addVehicleToggle{border:1px solid var(--line);border-radius:9px;background:var(--surface);color:var(--text);padding:6px 9px;font-size:12px;font-weight:800;cursor:pointer}.vehicleCards.compact{display:grid;gap:7px}.vehicleChoice{width:100%;display:grid;grid-template-columns:52px minmax(0,1fr) auto;gap:9px;align-items:center;border:1px solid var(--line);border-radius:12px;background:var(--surface);color:var(--text);padding:9px;text-align:left;cursor:pointer}.vehicleChoice.active{border-color:var(--orange);box-shadow:inset 3px 0 0 var(--orange);background:color-mix(in srgb,var(--orange) 5%,var(--surface))}.vehicleChoiceMain{min-width:0}.vehicleChoiceMain strong{display:block;font-size:12px}.vehicleChoiceMain small,.vehicleVin,.vehicleFacts{display:block;margin-top:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted);font-size:12px}.vehicleVin{font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.vehicleHistoryCount{border:1px solid var(--line);border-radius:999px;padding:4px 6px;color:var(--muted);font-size:12px}.vehicleAddCompact{margin-top:10px;border-top:1px solid var(--line);padding-top:10px;display:grid;gap:8px}.vehicleAddCompact button{border:0;border-radius:10px;background:var(--orange);color:#111;padding:10px;font-size:12px;font-weight:850;cursor:pointer}.vehicleAddCompact button:disabled{opacity:.45}.vehicleAddCompact small{color:var(--muted);font-size:12px;line-height:1.45}
      .activeVehicleSummary{display:grid;grid-template-columns:62px 1fr;gap:10px;align-items:center}.activeVehicleSummary strong{display:block;font-size:14px}.activeVehicleSummary span,.activeVehicleSummary small{display:block;margin-top:3px;color:var(--muted);font-size:12px}.inlineHistory{margin-top:11px;border-top:1px solid var(--line);padding-top:8px;display:grid;gap:5px}.inlineHistory>div{display:grid;grid-template-columns:80px 1fr auto;gap:7px;align-items:center;border:1px solid var(--line);border-radius:9px;background:var(--surface);padding:7px 8px;font-size:12px}.inlineHistory button{border:0;background:transparent;color:var(--orange);font-size:12px;font-weight:800;cursor:pointer}.inlineHistory p{margin:0;color:var(--muted);font-size:12px}
      .nextAction{width:100%;border:0;border-radius:11px;background:var(--orange);color:#111;padding:12px;font-size:12px;font-weight:900;cursor:pointer}.actionGrid{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:8px}.actionGrid button{min-height:40px;border:1px solid var(--line);border-radius:10px;background:var(--surface);color:var(--text);padding:8px;font-size:12px;font-weight:800;cursor:pointer}.actionGrid button:hover{border-color:var(--orange)}.actionGrid button.softDisabled{color:var(--muted);border-style:dashed}.gateHint{display:block;margin-top:8px;color:var(--muted);font-size:12px;line-height:1.45}
