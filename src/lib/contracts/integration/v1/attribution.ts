...
function parseTouch(value: unknown, field: string, required: boolean): AttributionTouchV1 | undefined {
  ...
  const touch: AttributionTouchV1 = { sourceClass };
...
export function deriveLegacyInquiryAttributionFieldsV1(snapshot: AttributionSnapshotV1): LegacyInquiryAttributionFieldsV1 {
...
export function attributionMetadataV1(snapshot: AttributionSnapshotV1) {
  return { attribution: snapshot } as const;
}
