...
const RULES: Rule[] = [
  ...
  { match: prefix("/api/public/diagnostic-card-pdf"), resolve: () => ({ kind: "PUBLIC_TOKEN", note: "Diagnostic Card PDF is available only through a high-entropy, expiring and revocable share token stored as a SHA-256 hash; the route returns no CRM metadata." }) },
