...
const RULES: Rule[] = [
  ...
  { match: exact("/api/customer-cabinet/context"), resolve: () => internal(PERMISSIONS.DIAGNOSTICS_READ, "LOCATION", "Customer cabinet context resolves only diagnostic cases visible within the caller's diagnostics location scope.") },
