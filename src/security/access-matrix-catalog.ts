...
export const PERMISSION_PRESENTATION: Record<PermissionCode, PermissionPresentation> = {
  ...
  [PERMISSIONS.WORK_ORDERS_READ]: { label: "Перегляд комерційних пропозицій", moduleLabel: "Комерційна пропозиція" },
  [PERMISSIONS.WORK_ORDERS_WRITE]: { label: "Редагування та статуси комерційної пропозиції", moduleLabel: "Комерційна пропозиція" },
  [PERMISSIONS.WORK_ORDERS_ESTIMATE]: { label: "Кошторис і погодження", moduleLabel: "Комерційна пропозиція", sensitive: true },
