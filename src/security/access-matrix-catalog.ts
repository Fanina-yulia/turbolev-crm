...
export const PERMISSION_PRESENTATION: Record<PermissionCode, PermissionPresentation> = {
  ...
  [PERMISSIONS.WORK_ORDERS_READ]: { label: "Перегляд нарядів", moduleLabel: "Комерційна пропозиція" },
  [PERMISSIONS.WORK_ORDERS_WRITE]: { label: "Редагування та статуси наряду", moduleLabel: "Комерційна пропозиція" },
