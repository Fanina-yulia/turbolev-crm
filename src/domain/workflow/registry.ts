...
export const WORKFLOW_DEFINITIONS: Readonly<Record<string, WorkflowDefinition>> = {
  ...
  WORK_ORDER: {
    entity: "WORK_ORDER", label: "Наряд-замовлення / ремонт", kind: "PROCESS", description: "Фактичний виробничий контур після діагностики або для прямого ремонту.", statuses: workOrderStatuses,
