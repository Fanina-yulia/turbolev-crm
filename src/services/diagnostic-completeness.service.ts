...
async function effectiveInspectionIds(diagnosticRequestId: string) {
  ...
  // Після переходу зі старого BASIC_INSPECTION на нову матрицю не змушуємо
  // механіка повторно проходити історичний шаблон. Його дані залишаються в БД,
  // але критерієм завершення стає актуальна матриця ходової + рідини.
