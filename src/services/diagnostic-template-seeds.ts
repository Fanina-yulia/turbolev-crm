...
export const DIAGNOSTIC_TEMPLATE_SEEDS: DiagnosticTemplateSeed[] = [
  ...
  { code:"SUSPENSION_MATRIX", name:"Матриця ходової", description:"Швидка діагностика ходової: вісь, сторона, вузол і великі відмітки тільки для деталей, що потребують заміни.", sortOrder:21, sections:[
    { code:"FRONT_SUSPENSION", name:"Передня підвіска", items:[
      ...
      {code:"ARM_FL",name:"Лівий передній важіль",position:"Передня ліва",work:"Заміна переднього важеля",part:"Важіль передній"},
      {code:"ARM_FR",name:"Правий передній важіль",position:"Передня права",work:"Заміна переднього важеля",part:"Важіль передній"},
      {code:"BUSH_FRONT_FL",name:"Лівий передній сайлентблок переднього важеля",position:"Передня ліва",work:"Заміна переднього сайлентблока переднього важеля",part:"Передній сайлентблок переднього важеля"},
      {code:"BUSH_FRONT_FR",name:"Правий передній сайлентблок переднього важеля",position:"Передня права",work:"Заміна переднього сайлентблока переднього важеля",part:"Передній сайлентблок переднього важеля"},
      {code:"BUSH_REAR_FL",name:"Лівий задній сайлентблок переднього важеля",position:"Передня ліва",work:"Заміна заднього сайлентблока переднього важеля",part:"Задній сайлентблок переднього важеля"},
      {code:"BUSH_REAR_FR",name:"Правий задній сайлентблок переднього важеля",position:"Передня права",work:"Заміна заднього сайлентблока переднього важеля",part:"Задній сайлентблок переднього важеля"},
      ...
      {code:"STAB_BUSH_FRONT",name:"Втулки переднього стабілізатора",work:"Заміна втулок переднього стабілізатора",part:"Втулки стабілізатора"}
    ]},
    ...
    { code:"FRONT_DRIVE", name:"Передній привід", items:[
      ...
      {code:"CV_BOOT_FL",name:"Лівий пильник зовнішнього ШРУСа",position:"Передня ліва",work:"Заміна пильника зовнішнього ШРУСа",part:"Пильник зовнішнього ШРУСа"},
      {code:"CV_BOOT_FR",name:"Правий пильник зовнішнього ШРУСа",position:"Передня права",work:"Заміна пильника зовнішнього ШРУСа",part:"Пильник зовнішнього ШРУСа"},
      {code:"CV_BOOT_INNER_FL",name:"Лівий пильник внутрішнього ШРУСа",position:"Передня ліва",work:"Заміна пильника внутрішнього ШРУСа",part:"Пильник внутрішнього ШРУСа"},
      {code:"CV_BOOT_INNER_FR",name:"Правий пильник внутрішнього ШРУСа",position:"Передня права",work:"Заміна пильника внутрішнього ШРУСа",part:"Пильник внутрішнього ШРУСа"},
    ...
    { code:"REAR_SUSPENSION", name:"Задня підвіска", items:[
      ...
      {code:"UPPER_LINK_RL",name:"Ліва верхня поперечна тяга",position:"Задня ліва",work:"Заміна верхньої поперечної тяги",part:"Поперечна тяга верхня"},
      {code:"UPPER_LINK_RR",name:"Права верхня поперечна тяга",position:"Задня права",work:"Заміна верхньої поперечної тяги",part:"Поперечна тяга верхня"},
      {code:"UPPER_LINK_BUSH_RL",name:"Лівий сайлентблок верхньої поперечної тяги",position:"Задня ліва",work:"Заміна сайлентблока верхньої поперечної тяги",part:"Сайлентблок верхньої поперечної тяги"},
      {code:"UPPER_LINK_BUSH_RR",name:"Правий сайлентблок верхньої поперечної тяги",position:"Задня права",work:"Заміна сайлентблока верхньої поперечної тяги",part:"Сайлентблок верхньої поперечної тяги"},
      {code:"LOWER_LINK_RL",name:"Ліва нижня поперечна тяга",position:"Задня ліва",work:"Заміна нижньої поперечної тяги",part:"Поперечна тяга нижня"},
      {code:"LOWER_LINK_RR",name:"Права нижня поперечна тяга",position:"Задня права",work:"Заміна нижньої поперечної тяги",part:"Поперечна тяга нижня"},
      {code:"LOWER_LINK_BUSH_RL",name:"Лівий сайлентблок нижньої поперечної тяги",position:"Задня ліва",work:"Заміна сайлентблока нижньої поперечної тяги",part:"Сайлентблок нижньої поперечної тяги"},
      {code:"LOWER_LINK_BUSH_RR",name:"Правий сайлентблок нижньої поперечної тяги",position:"Задня права",work:"Заміна сайлентблока нижньої поперечної тяги",part:"Сайлентблок нижньої поперечної тяги"},
      {code:"TRAILING_LINK_RL",name:"Ліва поздовжня тяга",position:"Задня ліва",work:"Заміна поздовжньої тяги",part:"Поздовжня тяга"},
      {code:"TRAILING_LINK_RR",name:"Права поздовжня тяга",position:"Задня права",work:"Заміна поздовжньої тяги",part:"Поздовжня тяга"},
      {code:"TRAILING_LINK_BUSH_RL",name:"Лівий сайлентблок поздовжньої тяги",position:"Задня ліва",work:"Заміна сайлентблока поздовжньої тяги",part:"Сайлентблок поздовжньої тяги"},
      {code:"TRAILING_LINK_BUSH_RR",name:"Правий сайлентблок поздовжньої тяги",position:"Задня права",work:"Заміна сайлентблока поздовжньої тяги",part:"Сайлентблок поздовжньої тяги"},
      {code:"ARM_RL",name:"Лівий поздовжній важіль",position:"Задня ліва",work:"Заміна поздовжнього важеля",part:"Поздовжній важіль"},
      {code:"ARM_RR",name:"Правий поздовжній важіль",position:"Задня права",work:"Заміна поздовжнього важеля",part:"Поздовжній важіль"},
      {code:"BUSH_RL",name:"Лівий сайлентблок поздовжнього важеля",position:"Задня ліва",work:"Заміна сайлентблока поздовжнього важеля",part:"Сайлентблок поздовжнього важеля"},
      {code:"BUSH_RR",name:"Правий сайлентблок поздовжнього важеля",position:"Задня права",work:"Заміна сайлентблока поздовжнього важеля",part:"Сайлентблок поздовжнього важеля"},
