...
export const MECHANIC_PART_DEFINITIONS: readonly MechanicPartDefinition[] = [
  {
    slug: "engine-protection",
    code: "ENGINE_PROTECTION",
    canonicalName: "Захист двигуна",
    category: "engine",
    aliases: [
      "захист двигуна",
      "захист мотора",
    ...
    providerTerms: {
      BM_PARTS: ["защита двигателя", "защита картера", "защита поддона"],
      UNITRADE: ["захист двигуна", "захист картера", "захист піддона"],
    },
  },
  {
    slug: "wheel-arch-liner",
    code: "WHEEL_ARCH_LINER",
    canonicalName: "Підкрилок",
    category: "body",
    aliases: [
      "підкрилок",
      "підкрилки",
      "підкрильник",
      "підкрилка",
      "підкрилок колісної арки",
      "підкрилки колісних арок",
      "захист колісної арки",
      "захист арки",
      "пластик колісної арки",
      "локер",
      "локери",
      "локер колеса",
      "локер передній",
    ...
    providerTerms: {
      BM_PARTS: ["подкрылок", "подкрылки", "локер"],
      UNITRADE: ["підкрилок", "підкрилки", "локер"],
    },
  },
  {
    slug: "control-arm",
  ...
  },
  {
    ...
    category: "steering",
    aliases: ["пильник рульової рейки", "пильник рейки", "пильовик рульової рейки", "пильовик рейки", "пильовика рульової рейки", "пыльник рулевой рейки", "пыльник рейки", "steering rack boot"],
    providerTerms: {
...
const EXPLICIT_CODE_MAP: Record<string, string> = {
  ENGINE_PROTECTION: "ENGINE_PROTECTION", ENGINE_GUARD: "ENGINE_PROTECTION", UNDERBODY_SHIELD: "ENGINE_PROTECTION",
  WHEEL_ARCH_LINER: "WHEEL_ARCH_LINER", FENDER_LINER: "WHEEL_ARCH_LINER", WHEEL_ARCH_LINERS: "WHEEL_ARCH_LINER",
