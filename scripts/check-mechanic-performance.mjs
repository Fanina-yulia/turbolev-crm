...
const cabinet = read("app/mechanic-cabinet.tsx");
const roleCabinet = read("app/role-cabinet.tsx");
const mobileCompatibility = read("app/mechanic-mobile-cabinet.tsx");
...
requireText(page, "<MechanicCabinet", "canonical mechanic cabinet mount");
requireText(cabinet, "<MechanicRequestCoordinator>", "mechanic coordinator mount gate");
requireText(roleCabinet, "<MechanicCabinet", "role cabinet canonical mount");
requireText(mobileCompatibility, "return <MechanicCabinet", "legacy cabinet compatibility mount");
