...
const linked = parseServiceAdvisorCabinetPayload({
  ...
  kpis: { today: 6, arrived: 2, approval: 1, waitingParts: 1, inRepair: 2, mechanicFindings: 1, diagnosticReviews: 1 },
  appointments: [{
    id: "appointment-1",
    status: "ARRIVED",
    start,
...
assert.equal(parseServiceAdvisorCabinetPayload({
  ...
  linked: true,
  station: { id: "station-1", name: "Глеваха" },
  kpis: { today: -1, arrived: 0, approval: 0, waitingParts: 0, inRepair: 0, mechanicFindings: 0, diagnosticReviews: 0 },
  appointments: [],
  diagnostics: [],
  mechanicFindings: [],
}), null);
...
assert.equal(parseServiceAdvisorCabinetPayload({
  ...
  linked: true,
  station: { id: "station-1", name: "Глеваха" },
  kpis: { today: 1, arrived: 1, approval: 0, waitingParts: 0, inRepair: 0, mechanicFindings: 0, diagnosticReviews: 0 },
...
assert.equal(parseServiceAdvisorCabinetPayload({
  ...
  linked: true,
  station: { id: "station-1", name: "Глеваха" },
  kpis: { today: 0, arrived: 0, approval: 0, waitingParts: 0, inRepair: 0, mechanicFindings: 1, diagnosticReviews: 0 },
  appointments: [],
  diagnostics: [],
  mechanicFindings: [{
