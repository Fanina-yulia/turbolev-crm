...
const checks = [
  ...
  ["reference text geometry", files.art.includes('textLength=\"129\"') && files.art.includes('textLength=\"202\"') && files.art.includes('textLength=\"130\"') && files.art.includes('font-size=\"106\"')],
